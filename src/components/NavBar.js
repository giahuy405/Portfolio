...
const CustomMobileLink = ({ href, title, className = "", toggle }) => {
  ...
  return (
    <button className={`${className} relative group`} onClick={handleClick}>
      ...
      <span
        className={`h-0.5 inline-block bg-light dark:bg-dark absolute left-0 -bottom-0.5 
...
//   }, [modalRef]);
  ...
  return (
    <header className="w-full px-32 md:px-8 py-8 font-medium flex items-center justify-between md:mb-6">
      ...
      >
        <span
          className={`bg-dark dark:bg-light block h-0.5 w-6 rounded-sm duration-300 ${
      ...
      <div className="flex justify-between w-full lg:hidden">
        ...
        <nav className="flex items-center gap-4">
          <motion.a
            href="https://github.com/giahuy405"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          >
          ...
          <motion.a
            href="https://www.youtube.com/channel/UCBt5JwDxsTFmwFwaz8rDuUA"
            target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          >
      ...
      {isOpen && (
        ...
        <div ref={modalRef}>
          {/* trick nhỏ để cái nút này ở trùng modal ref thì khi click nó sẽ tự đống */}
          {/* <button
            className="lg:flex flex-col justify-center items-center hidden fixed left-8 top-8"
            onClick={handleClick}
          >
            <span
              className={`bg-dark dark:bg-light block h-0.5 w-6 rounded-sm duration-300 ${
          ...
          >
            <nav className="flex flex-col items-center justify-center gap-5">
              ...
              <CustomMobileLink
                ...
                toggle={handleClick}
              />
              <button className="cursor-not-allowed text-light dark:text-dark mb-10">
                Articles
              </button>
            </nav>
