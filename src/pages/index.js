        ...
        <Layout className='pt-0'>
          <div className='flex items-center justify-between w-full md:block'>
            <div className='w-1/2 md:w-[100%]'>
              <Image priority src={profilePic} alt='phamgiahuy' className='w-full h-auto' />
            </div>
            <div className='w-1/2 md:w-full flex flex-col items-center text-left'>
              ...
              <AnimatedText text={`My name is Pham Gia huy. `} className='!text-6xl !text-left lg:!text-5xl md:!text-4xl sm:!text-3xl ' />
